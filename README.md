...
![SingleStitch](animations/SingleStitch.gif)

## Horizontal Stitches

A normal row of stitches.

![HorizontalStitches](animations/HorizontalStiches.gif)

## Vertical Stitches

I default to horizontal stitches, only using vertical stitches when the pattern is long/thin (plants, trees etc.)

![Vertical Stitches](animations/VerticalStitches.gif)
...
![HorizontalExpandingDown](animations/HorizontalExpandingDown.gif)
...
![HorizontalGoingBelow](animations/HorizontalGoingBelow.gif)
...
![JumpAbove](animations/JumpAbove.gif)
...
![JumpBelow](animations/JumpBelow.gif)
